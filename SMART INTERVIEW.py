...
<body>
  <div class="container">
    ...
    <a href="/admin/visual_dashboard" class="visual-icon">
      <img src="/static/vis.gif" alt="Visual Dashboard">
    </a>
  </div>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
  <script>
...
def submit_interview(submission: InterviewSubmission):
    ...
    for qa, resp in zip(qas, submission.responses):
        ...
        candidate_answer = resp.candidate_answer  # Fixed line
        evaluation = {
            "question": question_text,
            "candidate_answer": candidate_answer,
        }
        if "answer" in qa:  # Level 2 interview with predefined correct answers
            correct_answer = qa["answer"]
            evaluation["correct_answer"] = correct_answer
            # Remove question words from candidate answer to focus on content
            ...
            if not filtered_answer:
                ...
                # Use TF-IDF to calculate similarity between candidate and correct answer
                ...
                score = round(similarity * 5, 2)  # Scale similarity to a score out of 5
        else:  # Level 3 interview without predefined answers
            score = evaluate_answer_with_llama(question_text, candidate_answer)
        evaluation["score"] = score
        evaluation["feedback"] = f"Your score: {score} out of 5."
